    ...
    <div class="min-h-screen bg-gray-50 flex items-center justify-center p-4 sm:p-6">
        ...
        <div class="w-full max-w-[420px]">
            ...
            <div class="bg-white rounded-2xl border border-gray-200 shadow-sm p-8">
                ...
                {{-- Session Status --}}
                @if (session('status'))
                    <div class="mb-5 p-3 bg-green-50 border border-green-200 text-green-700 rounded-lg text-sm font-medium text-center">
                        {{ session('status') }}
                    </div>
                @endif
                    ...
                    <div>
                        <div class="flex items-center justify-between mb-1.5">
                            ...
                            @if (Route::has('password.request'))
                                <a href="{{ route('password.request') }}" class="text-xs font-medium text-gray-500 hover:text-gray-900 transition">
                                    Forgot?
                                </a>
                            @endif
                        </div>
            ...
            <p class="text-center text-sm text-gray-500 mt-6">
                ...
                <a href="{{ route('register') }}" class="font-semibold text-gray-900 hover:underline">Create one</a>
            </p>
